...
\label{sec:org49e09be}
\chapter{Introduction}
\label{sec:org9403841}
\chapter{Background}
\label{sec:orgcbe8ade}
...
\label{sec:orgfb5096f}
\subsection{Agda}
\label{sec:org20f6ebe}
...
\label{sec:orgc8d5bc0}
\chapter{Project}
\label{sec:org9fae07d}
Example \cite{mckinna_why_2006}
\chapter{Case Studies}
\label{sec:org8cda9d9}

\part{Assessments and Future Work}
\label{sec:org31baf5b}
\chapter{Assessments and Conclusions}
\label{sec:org712bd49}
\chapter{Future Work}
\label{sec:org81fbbbf}
