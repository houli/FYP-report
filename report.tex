...
\label{sec:orgf9296d2}
\chapter{Background}
\label{sec:org70111af}
...
\label{sec:org38e0466}
\subsection{Agda}
\label{sec:org72754ae}
...
\chapter{My Project}
\label{sec:org33c87bc}

\section{Objectives}
\label{sec:orgbdcccc5}

\section{Approach}
\label{sec:orgff88a6a}

\section{Interactive Editing Modes for Idris}
\label{sec:org2370aae}
...
\label{sec:org789b33e}
\chapter{Case Studies}
\label{sec:org0ab65bb}
\chapter{Assessments and Conclusions}
\label{sec:org9b02af2}
\chapter{Future Work}
\label{sec:org01aa242}
