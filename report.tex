...
\label{sec:org9272a62}
\chapter{Background}
\label{sec:org51b9f93}
...
\label{sec:org8bffccc}
\subsection{Agda}
\label{sec:org83d44bc}
...
\label{sec:org9a05f5b}

\section{Objectives}
\label{sec:orge110408}
...
\label{sec:orgf0cf9c8}
\chapter{Case Studies}
\label{sec:orgdd1000a}
\chapter{Assessments and Conclusions}
\label{sec:org7bf2fcc}
\chapter{Future Work}
\label{sec:org23837b1}
