...
\label{sec:orgff023a9}
\chapter{Background}
\label{sec:org7cfb42a}
...
\begin{minted}[frame=single,fontsize=\normalsize,linenos,escapeinside=\#\#]{haskell}
plusOne x = x + 1
\end{minted}
...
\label{sec:org2392db7}
\subsection{Agda}
\label{sec:orgae805f3}
...
\begin{minted}[frame=single,fontsize=\normalsize,linenos,escapeinside=\#\#]{agda}
data #$ℕ$# : Set where
  zero : #$ℕ$#
  suc : #$ℕ$# → #$ℕ$#
\end{minted}
...
\begin{minted}[frame=single,fontsize=\normalsize,linenos,escapeinside=\#\#]{idris}
...
\chapter{My Project}
\label{sec:orga821104}

\section{Objectives}
\label{sec:orgde431c2}

\section{Approach}
\label{sec:org67f34dc}

\section{Type-Driven-Development}
\label{sec:org6ba7c27}

\section{Interactive Editing Modes for Idris}
\label{sec:org809b56f}
\chapter{Case Studies}
\label{sec:org2bae138}
\chapter{Assessments and Conclusions}
\label{sec:org20b9978}
\chapter{Future Work}
\label{sec:org79d2dfc}
